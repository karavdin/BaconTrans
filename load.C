{
  //  gSystem->AddIncludePath("-I/afs/desy.de/user/k/karavdia/CMSSW_7_6_3/src/UHH2/BaconTrans/baconheaders/");
  //  gSystem->AddLinkedLibs("-L/afs/desy.de/user/k/karavdia/SFrame_04_00_01_CMSSW763/lib -lSUHH2bacondataformats");
